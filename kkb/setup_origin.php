...
define('DB_DATABASE_NAME', 'portdb');

/* we can use it anywhere */
/* global varriable */
$admin_file = 'admin.php';
$index_file = 'index.php';
$senghak_index_file = 'senghak_index.php';

$senghak_index_file = 'senghak_index.php';
$saradeth_index_file = 'saradeth_index.php';
...
class PORT_SMARTY extends Smarty
{
